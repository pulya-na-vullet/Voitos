...
MOBILE_MIN_VERSION_CODE = env.int("MOBILE_MIN_VERSION_CODE", default=14)
MOBILE_LATEST_VERSION_CODE = env.int("MOBILE_LATEST_VERSION_CODE", default=14)
MOBILE_LATEST_VERSION_NAME = env("MOBILE_LATEST_VERSION_NAME", default="0.2.10-kmp")
