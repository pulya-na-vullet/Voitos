...
MOBILE_MIN_VERSION_CODE = env.int("MOBILE_MIN_VERSION_CODE", default=32)
MOBILE_LATEST_VERSION_CODE = env.int("MOBILE_LATEST_VERSION_CODE", default=32)
MOBILE_LATEST_VERSION_NAME = env("MOBILE_LATEST_VERSION_NAME", default="0.2.28-kmp")
MOBILE_APK_URL = env(
    "MOBILE_APK_URL",
    default=(
