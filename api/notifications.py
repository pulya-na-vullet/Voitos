...
DEEP_LINKS: dict[str, str] = {
    ...
    "work_request.slots_ready": "voitos://app/work-requests/{id}",
    "work_request.schedule_master": "voitos://app/executor/jobs/{id}",
    "work_request.confirm_amount": "voitos://app/work-requests/{id}/confirm",
    "work_request.rate": "voitos://app/work-requests/{id}/rate",
    "work_request.in_progress": "voitos://app/work-requests/{id}",
    ...
    "executor.role_approved": "voitos://app/executor/register",
    "executor.role_rejected": "voitos://app/executor/register",
