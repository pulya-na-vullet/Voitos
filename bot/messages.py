...
def help_message(user: BotUser) -> str:
    ...
    return (
        ...
        "• Исполнители — «стать исполнителем»: трактор, камаз, электрик, "
        "грузчик, репетиторы и другие роли; для части ролей нужно фото документа. "
        "Вызвать мастера: «вызвать исполнителя» / «нужен электрик» + фото\n"
